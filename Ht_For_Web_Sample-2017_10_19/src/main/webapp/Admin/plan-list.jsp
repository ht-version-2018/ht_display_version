...
<div class="page-container">
	...
	<div class="cl pd-5 bg-1 bk-gray mt-20"> <span class="l"><a href="javascript:;" onclick="datadel()" class="btn btn-danger radius"><i class="Hui-iconfont">&#xe6e2;</i> 批量删除</a> <a class="btn btn-primary radius" data-title="添加方案" _href="add-plan1.jsp" onclick="Hui_admin_tab(this)" href="javascript:;"><i class="Hui-iconfont">&#xe600;</i> 添加方案</a></span> <span class="r">共有数据：<strong>54</strong> 条</span> </div>
	<div class="mt-20">
		...
		success:function(data){
		    ...
		    for(var i=0;i<data.length;i++){
		   		$("#tbody").append('<tr class="text-c">'
					+'<td><input type="checkbox" value="" name=""></td>'
					+'<td>'+data[i].planId+'</td>'
					+'<td class="text-l"><a class="maincolor" href="javascript:;" onclick="picture_edit(\'方案编辑\',\'Admin\/picture-show.jsp\','+data[i].planId+')">'+data[i].planName+'</u></td>'
					+'<td>'+data[i].planFloor+'</td>'
					+'<td>'+data[i].planMinArea+'</td>'
					+'<td>'+data[i].planMaxArea+'</td>'
					+'<td>'+data[i].planPicPath+'</td>'
					+'<td class="td-status"><span class="label label-success radius">已发布</span></td>'
					+'<td class="f-14 td-manage"><a style="text-decoration:none" onClick="article_stop(this,\'10001\')" href="javascript:;" title="下架"><i class="Hui-iconfont">&#xe6de;</i></a> <a style="text-decoration:none" class="ml-5" onClick="article_edit(\'资讯编辑\',\'article-add.html\',\'10001\')" href="javascript:;" title="编辑"><i class="Hui-iconfont">&#xe6df;</i></a> <a style="text-decoration:none" class="ml-5" onClick="article_del(this,\'10001\')" href="javascript:;" title="删除"><i class="Hui-iconfont">&#xe6e2;</i></a></td>'
				+'</tr>');
		    }

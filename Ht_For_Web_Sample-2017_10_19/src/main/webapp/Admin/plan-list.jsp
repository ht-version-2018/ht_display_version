...
<link rel="stylesheet" href="Admin/lib/laypage/1.2/plugins/layui/css/layui.css" media="all" />
<!--[if IE 6]>
...
<div class="page-container">
	...
	<div class="cl pd-5 bg-1 bk-gray mt-20"> <span class="l"><a href="javascript:;" onclick="datadel()" class="btn btn-danger radius"><i class="Hui-iconfont">&#xe6e2;</i> 批量删除</a> <a class="btn btn-primary radius" data-title="添加方案" href="Admin/plan-add.jsp" onclick="Hui_admin_tab(this)" href="javascript:;"><i class="Hui-iconfont">&#xe600;</i> 添加方案</a></span> <span class="r">共有数据：<strong id="num"></strong> 条</span> </div>
	<div class="mt-20">
...
<script type="text/javascript" src="Admin/js/plan.js"></script>
...
$(document).ready(function(){
	getPlanList(pageNow, searchInfo);
	showPage();
})

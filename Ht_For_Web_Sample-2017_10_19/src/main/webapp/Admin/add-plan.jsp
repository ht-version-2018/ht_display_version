...
<div class="page-container">
	<form class="form form-horizontal" id="form-plan-add" enctype="multipart/form-data">
		<div class="row cl">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="file" id="mainPic" name="mainPic" required/>
			</div>
		</div>
		<!--立面图上传-->
		<!-- 
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">立面图上传：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="file" id="Eleva" />
			</div>
		</div> -->
<!-- 注释开始 -->

	<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">方案封面图片上传：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<div class="uploader-list-container"> 
					<div class="queueList">
						<div id="dndArea" class="placeholder">
							<div id="filePicker-2"></div>
							<p>或将照片拖到这里，封面图片限制为1张</p>
						</div>
					</div>
...
$(function(){
	...
	var uploader = WebUploader.create({
		...
		server: 'http://localhost:8080/Ht_For_Web-2017_10_19/fileUpload',

...
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 工程管理 <span class="c-gray en">&gt;</span> 工程列表 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
		...
		success:function(data){
		    ...
		    for(var i=0;i<data.length;i++){
		   		$("#tbody").append("<tr class='text-c'>"
					...
					+"<td class='text-l'><u style='cursor:pointer' class='text-primary' onClick='article_edit('查看','article-zhang.html','10001')' title='查看'>"+data[i].projectName+"</u></td>"
					+"<td>"+data[i].projectPlace+"</td>"
					+"<td>"+data[i].projectIntro+"</td>"
					+"<td>"+data[i].mainPic+"</td>"
					+"<td class='td-status'><span class='label label-success radius'>已发布</span></td>"
					+"<td class='f-14 td-manage'><a style='text-decoration:none' onClick='article_stop(this,'10001')' href='javascript:;' title='下架'><i class='Hui-iconfont'>&#xe6de;</i></a> <a style='text-decoration:none' class='ml-5' onClick='article_edit('资讯编辑','article-add.html','10001')' href='javascript:;' title='编辑'><i class='Hui-iconfont'>&#xe6df;</i></a> <a style='text-decoration:none' class='ml-5' onClick='article_del(this,'10001')' href='javascript:;' title='删除'><i class='Hui-iconfont'>&#xe6e2;</i></a></td>"
				+"</tr>");
		    }

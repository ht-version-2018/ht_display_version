	...
	<div class="tn3 album">
	 <!--  <h4>试点公共图纸</h4>
		...
		<li>
		    ...
		    <a href="/prjImg/奉化大埠村文化礼堂/工程图纸/2.jpg">
			<img src="/prjImg/奉化大埠村文化礼堂/工程图纸/2.jpg" />
		    </a>
		</li>
		<li>
		    <h4>Isolated sandy cove</h4>
		    <div class="tn3 description">Zakynthos island, Greece</div>
		    <a href="/prjImg/奉化大埠村文化礼堂/工程图纸/3.jpg">
			<img src="/prjImg/奉化大埠村文化礼堂/工程图纸/3.jpg" />
		    </a>
		</li>
		<li>
		    <h4>Isolated sandy cove</h4>
		    <div class="tn3 description">Zakynthos island, Greece</div>
		    <a href="/prjImg/奉化大埠村文化礼堂/工程图纸/4.jpg">
			<img src="/prjImg/奉化大埠村文化礼堂/工程图纸/4.jpg" />
		    </a>
		</li>
		<li>
		    <h4>Isolated sandy cove</h4>
		    <div class="tn3 description">Zakynthos island, Greece</div>
		    <a href="/prjImg/奉化大埠村文化礼堂/工程图纸/5.jpg">
			<img src="/prjImg/奉化大埠村文化礼堂/工程图纸/5.jpg" />
		    </a>
		</li>
		<li>
		    <h4>Isolated sandy cove</h4>
		    <div class="tn3 description">Zakynthos island, Greece</div>
		    <a href="/prjImg/奉化大埠村文化礼堂/工程图纸/6.jpg">
			<img src="/prjImg/奉化大埠村文化礼堂/工程图纸/6.jpg" />
		    </a>
		</li>
		<li>
		    <h4>Isolated sandy cove</h4>
		    <div class="tn3 description">Zakynthos island, Greece</div>
		    <a href="/prjImg/奉化大埠村文化礼堂/工程图纸/7.jpg">
			<img src="/prjImg/奉化大埠村文化礼堂/工程图纸/7.jpg" />
		    </a>
		</li>
		<li>
		    <h4>Isolated sandy cove</h4>
		    <div class="tn3 description">Zakynthos island, Greece</div>
		    <a href="/prjImg/奉化大埠村文化礼堂/工程图纸/8.jpg">
			<img src="/prjImg/奉化大埠村文化礼堂/工程图纸/8.jpg" />
		    </a>
		</li>
		<li>
		    <h4>Isolated sandy cove</h4>
		    <div class="tn3 description">Zakynthos island, Greece</div>
		    <a href="/prjImg/奉化大埠村文化礼堂/工程图纸/9.jpg">
			<img src="/prjImg/奉化大埠村文化礼堂/工程图纸/9.jpg" />
		    </a>
		</li>
		<li>
		    <h4>Isolated sandy cove</h4>
		    <div class="tn3 description">Zakynthos island, Greece</div>
		    <a href="/prjImg/奉化大埠村文化礼堂/工程图纸/10.jpg">
			<img src="/prjImg/奉化大埠村文化礼堂/工程图纸/10.jpg" />
		    </a>
		</li>
		<li>
		    <h4>Isolated sandy cove</h4>
		    <div class="tn3 description">Zakynthos island, Greece</div>
		    <a href="/prjImg/奉化大埠村文化礼堂/工程图纸/11.jpg">
			<img src="/prjImg/奉化大埠村文化礼堂/工程图纸/11.jpg" />
		    </a>
		</li>
	</ul>
	</div>
	...
	$.ajax({
		...
		success:function(data){
			...
			if(tag==1){
				...
				if(tag==2){
					/* $("#designPic").html(""); */
					/* $('ul li').remove();$('ul li').remove();$('ul li').remove(); */
// 					$('ul li').each(function(){
// 					    $(this).remove();
// 					}); 
					/* $("#designPic").append(
							'<li><h4>Hohensalzburg Castle</h4>'
						   +'<div class="tn3 description">Salzburg, Austria</div>'
						    +'<a href="/prjImg/'+prjName+'/工程图纸/'+data[i].picName+'" >'
							+'<img src="/prjImg/'+prjName+'/工程图纸/'+data[i].picName+'" />'
						    +'</a></li>'); */
				}
			}
	});
